...
The peak median is the reason this dataset exists. Published journey times are almost always the fastest service of the day, which is rarely the one a commuter can catch; holding both figures makes the difference measurable. Across the 421 direct routes the peak is slower than the advertised best on 390 of them and faster on none, by a median of 5 minutes and by as much as 29.
