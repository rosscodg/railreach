# Train times from Woldingham to London

Woldingham connects to 3 London terminals. The fastest route is London Bridge in 32 minutes on a direct train.

- Fastest journey to London: 32 minutes to London Bridge
- Direct service: Yes
...
## Woldingham to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 32 min | same as fastest | 32 | 1.2 | Southeastern, Southern, Thameslink |
| Victoria | 33 min | same as fastest | 33 | 2.0 | Southeastern, Southern |
| St Pancras | 48 min | same as fastest | 48 | 1.2 | Thameslink, East Midlands Railway, Southeastern high speed |
...
London Bridge is the quickest at 32 minutes, on a direct service. Direct trains run to London Bridge, Victoria, St Pancras.
...
### What are the nearest stations to Woldingham?

The closest alternatives are Caterham, Whyteleafe South, Upper Warlingham. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/woldingham/
