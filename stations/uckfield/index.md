# Train times from Uckfield to London

Uckfield connects to 2 London terminals. The fastest route is London Bridge in 80 minutes on a direct train.

- Fastest journey to London: 80 minutes to London Bridge
- Direct service: Yes
...
## Uckfield to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 80 min | same as fastest | 80 | 0.8 | Southeastern, Southern, Thameslink |
...
London Bridge is the quickest at 80 minutes, on a direct service. Direct trains run to London Bridge.
...
### What are the nearest stations to Uckfield?

The closest alternatives are Buxted, Cooksbridge, Crowborough. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/uckfield/
