# Train times from Stonegate to London

Stonegate connects to 3 London terminals. The fastest route is London Bridge in 60 minutes on a direct train.

- Fastest journey to London: 60 minutes to London Bridge
- Direct service: Yes
...
## Stonegate to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 60 min | same as fastest | 66 | 2.0 | Southeastern, Southern, Thameslink |
| Victoria | 79 min (change at Tunbridge Wells) | no direct service | - | - | Southeastern, Southern |
| St Pancras | 84 min (change at London Bridge) | no direct service | - | - | Thameslink, East Midlands Railway, Southeastern high speed |
...
London Bridge is the quickest at 60 minutes, on a direct service. Direct trains run to London Bridge.
...
### What are the nearest stations to Stonegate?

The closest alternatives are Etchingham, Wadhurst, Robertsbridge. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/stonegate/
