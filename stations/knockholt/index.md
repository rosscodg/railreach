# Train times from Knockholt to London

Knockholt connects to 3 London terminals. The fastest route is London Bridge in 34 minutes, with one change.
...
## Knockholt to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 34 min (change at Orpington) | 37 min | 44 | 2.0 | Southeastern, Southern, Thameslink |
| Victoria | 45 min (change at Orpington) | no direct service | - | - | Southeastern, Southern |
...
London Bridge is the quickest at 34 minutes, though it requires a change. Direct trains run to none; all routes require a change.
...
No direct service is recorded from Knockholt; all routes into London require one change.

### What are the nearest stations to Knockholt?

The closest alternatives are Chelsfield, Orpington, Shoreham (Kent). These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/knockholt/
