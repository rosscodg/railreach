# Train times from St Leonards Warrior Square to London

St Leonards Warrior Square connects to 1 London terminal. The fastest route is London Bridge in 82 minutes on a direct train.
...
## St Leonards Warrior Square to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 82 min | same as fastest | 96 | 3.2 | Southeastern, Southern, Thameslink |
...
London Bridge is the quickest at 82 minutes, on a direct service. Direct trains run to London Bridge.
...
### What are the nearest stations to St Leonards Warrior Square?

The closest alternatives are Hastings, West St Leonards, Crowhurst. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/st-leonards-warrior-square/
