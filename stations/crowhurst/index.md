# Train times from Crowhurst to London

Crowhurst connects to 1 London terminal. The fastest route is London Bridge in 82 minutes on a direct train.
...
## Crowhurst to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 82 min | same as fastest | 88 | 2.0 | Southeastern, Southern, Thameslink |
...
### What are the nearest stations to Crowhurst?

The closest alternatives are Battle, West St Leonards, St Leonards Warrior Square. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/crowhurst/
