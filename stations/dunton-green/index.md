# Train times from Dunton Green to London

Dunton Green connects to 3 London terminals. The fastest route is London Bridge in 39 minutes, with one change.

- Fastest journey to London: 39 minutes to London Bridge
...
## Dunton Green to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 39 min (change at Orpington) | 42 min | 49 | 2.0 | Southeastern, Southern, Thameslink |
| Victoria | 47 min (change at Sevenoaks) | no direct service | - | - | Southeastern, Southern |
| St Pancras | 70 min (change at London Bridge) | no direct service | - | - | Thameslink, East Midlands Railway, Southeastern high speed |
...
London Bridge is the quickest at 39 minutes, though it requires a change. Direct trains run to none; all routes require a change.
...
No direct service is recorded from Dunton Green; all routes into London require one change.

### What are the nearest stations to Dunton Green?

The closest alternatives are Bat & Ball, Sevenoaks, Otford. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/dunton-green/
