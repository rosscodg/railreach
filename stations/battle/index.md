# Train times from Battle to London

Battle connects to 2 London terminals. The fastest route is London Bridge in 71 minutes on a direct train.

- Fastest journey to London: 71 minutes to London Bridge
- Direct service: Yes
...
## Battle to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 71 min | same as fastest | 82 | 3.2 | Southeastern, Southern, Thameslink |
| Victoria | 89 min (change at Tunbridge Wells) | no direct service | - | - | Southeastern, Southern |
...
London Bridge is the quickest at 71 minutes, on a direct service. Direct trains run to London Bridge.
...
### What are the nearest stations to Battle?

The closest alternatives are Crowhurst, West St Leonards, St Leonards Warrior Square. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/battle/
