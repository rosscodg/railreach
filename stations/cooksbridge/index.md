# Train times from Cooksbridge to London

Cooksbridge connects to 3 London terminals. The fastest route is London Bridge in 65 minutes, with one change.
...
## Cooksbridge to each London terminal

| London terminal | Fastest | Fastest direct | Typical peak | Peak trains/hr | Operator |
| --- | --- | --- | --- | --- |
| London Bridge | 65 min (change at Gatwick Airport) | no direct service | - | - | Southeastern, Southern, Thameslink |
| Victoria | 65 min | same as fastest | 66 | 0.4 | Southeastern, Southern |
| St Pancras | 80 min (change at Gatwick Airport) | no direct service | - | - | Thameslink, East Midlands Railway, Southeastern high speed |
...
London Bridge is the quickest at 65 minutes, though it requires a change. Direct trains run to Victoria.
...
### What are the nearest stations to Cooksbridge?

The closest alternatives are Lewes, Plumpton, Glynde. These can offer a faster or cheaper route into London depending on where you live.
...
Source: RailReach - https://railreach.co.uk/stations/cooksbridge/
